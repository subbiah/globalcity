class ApplicationController < ActionController::Base
  ...
  devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:email, :password, :password_confirmation, :otp, :otpflag, :active, :mobile, :gclife_registration, :gclife_registration_flatdetails[0]) }
